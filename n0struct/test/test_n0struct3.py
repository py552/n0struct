...
def test_files_processing():
    ...
    n0debug("test_ini")
    save_file(os.path.join(mydir, "test.tmp"), test_ini, mode='wb', EOL='\n')
    n0debug("test_ini")
    save_file(os.path.join(mydir, "test.tmp"), test_ini, mode='wb', EOL='\n')
    ...
    n0debug_calc(load_file(os.path.join(mydir,      "CRLF2.csv")).encode('utf-8'),              "CRLF2      read_mode='t'")
    n0debug_calc(load_file(os.path.join(mydir,      "CRLF2.csv"), read_mode='b'),               "CRLF2      read_mode='b'")
    n0debug_calc(list(load_lines(os.path.join(mydir,"CRLF2.csv"))),                             "CRLF2lines read_mode='t'")
    n0debug_calc(list(load_lines(os.path.join(mydir,"CRLF2.csv"))),                             "CRLF2lines read_mode='b'")
    n0debug_calc(list(load_csv(os.path.join(mydir,  "CRLF2.csv"))),                             "CRLF2csv   read_mode='t'")
    n0debug_calc(list(load_csv(os.path.join(mydir,  "CRLF2.csv"), read_mode='b')),              "CRLF2csv   read_mode='b'")
    ...
    n0debug_calc(load_file(os.path.join(mydir,      "LF2.csv")).encode('utf-8'),                "LF2        read_mode='t'")
    n0debug_calc(load_file(os.path.join(mydir,      "LF2.csv"), read_mode='b'),                 "LF2        read_mode='b'")
    n0debug_calc(list(load_lines(os.path.join(mydir,"LF2.csv"))),                               "LFlines    read_mode='t'")
    n0debug_calc(list(load_lines(os.path.join(mydir,"LF2.csv"))),                               "LFlines    read_mode='b'")
    n0debug_calc(list(load_csv(os.path.join(mydir,  "LF2.csv"))),                               "LF2csv     read_mode='t'")
    n0debug_calc(list(load_csv(os.path.join(mydir,  "LF2.csv"), read_mode='b')),                "LF2csv     read_mode='b'")
    ...
    n0debug_calc(load_file(os.path.join(mydir,      "CR2.csv")).encode('utf-8'),                "CR2        read_mode='t'")
    n0debug_calc(load_file(os.path.join(mydir,      "CR2.csv"), read_mode='b'),                 "CR2        read_mode='b'")
    n0debug_calc(list(load_lines(os.path.join(mydir,"CR2.csv"))),                               "CR2lines   read_mode='t'")
    n0debug_calc(list(load_lines(os.path.join(mydir,"CR2.csv"))),                               "CR2lines   read_mode='b'")
    n0debug_calc(list(load_csv(os.path.join(mydir,  "CR2.csv"))),                               "CR2csv     read_mode='t'")
    n0debug_calc(list(load_csv(os.path.join(mydir,  "CR2.csv"), read_mode='b')),                "CR2csv     read_mode='b'")
    n0debug_calc(list(load_csv(os.path.join(mydir,  "CR2.csv"), read_mode='b', EOL='\r')),      "CR2csv     read_mode='b' EOL='\\r'")
    ...
    n0debug_calc(load_file(os.path.join(mydir,      "LFCR2.csv")).encode('utf-8'),              "LFCR2      read_mode='t'")
    n0debug_calc(load_file(os.path.join(mydir,      "LFCR2.csv"), read_mode='b'),               "LFCR2      read_mode='b'")
    n0debug_calc(list(load_lines(os.path.join(mydir,"LFCR2.csv"))),                             "LFCR2lines read_mode='t'")
    n0debug_calc(list(load_lines(os.path.join(mydir,"LFCR2.csv"))),                             "LFCR2lines read_mode='b'")
    n0debug_calc(list(load_csv(os.path.join(mydir,  "LFCR2.csv"))),                             "LFCR2csv   read_mode='t'")
    n0debug_calc(list(load_csv(os.path.join(mydir,  "LFCR2.csv"), read_mode='b')),              "LFCR2csv   read_mode='b'")
    n0debug_calc(list(load_csv(os.path.join(mydir,  "LFCR2.csv"), read_mode='b', EOL='\n\r')),  "LFCR2csv   read_mode='b' EOL='\\n\\r'")
